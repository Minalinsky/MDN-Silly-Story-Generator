...
function getRandomValue(textArray){
...
function result() {
  ...
  var x = getRandomValue(insertX); //xItem dado no enunciado
  var y = getRandomValue(insertY); //yItem dado no enunciado
  var z = getRandomValue(insertZ); //zItem dado no enunciado
